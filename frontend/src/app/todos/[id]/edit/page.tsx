...
export default function EditTodo({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 border-emerald-500 bg-gray-900 border  shadow-md rounded-lg mt-10">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="flex justify-between mt-6">
          <button
            type="submit"
            className="w-20 min-w-min p-3 text-lg text-white bg-emerald-500 rounded-lg hover:bg-emerald-600 transition focus:ring-[3px] ring-emerald-400 focus-within:outline-none focus:ring-emerald-400"
          >
            Edit
          </button>
          <Link
            href={`/todos/${id}`}
            className="text-lg text-white mx-2 py-2 px-4 border border-emerald-500 rounded-lg hover:bg-emerald-500/50 focus:ring-2 ring-emerald-400 transition text-center flex items-center justify-center focus-within:outline-none focus:ring-emerald-500 "
          >
            Cancel
          </Link>
        </div>
